...
template HWRawBits<224> KernelManagerBlockSync::readInput< HWRawBits<224> >(const t_port_number port_number);
...
template HWRawBits<32> slice<32,32>(const HWRawBits<224> &a);
...
template HWRawBits<32> slice<192,32>(const HWRawBits<224> &a);
...
template HWRawBits<32> slice<64,32>(const HWRawBits<224> &a);
template HWRawBits<32> slice<0,32>(const HWRawBits<224> &a);
