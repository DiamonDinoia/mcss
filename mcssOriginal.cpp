...
static const double kMolierBc[] = {877.879, 1.02281, 1645.05, 888.813,
                                   12481.2};  // 1/mm
static const double kMolierXc2[] = {0.0661905, 7.88813e-05, 0.17879, 0.0647072,
                                    9.72643};  // MeV^2/mm
...
void RotateToLabFrame(double& u, double& v, double& w, double u1, double u2,
                      double u3) {
...
void Simulate(std::size_t theNumHists, double theMFP, double theScrPar,
              double theLimit) {
